  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover bg-clip-padding text-sm text-popover-foreground shadow-lg transition-none", 
          ...
          "data-[side=right]:data-[state=open]:animate-slide-in-right data-[side=right]:data-[state=closed]:animate-slide-out-right",
